        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <div class="row">
                  ...
                  <div class='huge'><?php echo $numberOfPosts = numberOfPosts(); ?></div>
                        <div>All Posts</div>
                    </div>
                </div>
            </div>
        ...
        <div class="panel panel-green">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                     <div class='huge'><?php echo $numberOfComments = numberOfComments(); ?></div>
        ...
        <div class="panel panel-yellow">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                    <div class='huge'><?php echo $numberOfUsers = numberOfUsers(); ?></div>
                        <div> Users</div>
                    </div>
                </div>
            </div>
        ...
        <div class="panel panel-red">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class='huge'><?php echo $numberOfCats= numberOfCats(); ?></div>
                         <div>Categories</div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
            var data = google.visualization.arrayToDataTable([
                ...
                <?php
                    $numberOfActivePosts = numberOfActivePosts();
